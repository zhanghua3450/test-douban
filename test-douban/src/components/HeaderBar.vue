<template>
  <div class="header-bar">
    ...
    <ul class="nav">
      <li>
        <router-link :to="{name:'MovieView'}" style="color:rgb(35, 132, 232)">
          电影
        </router-link>
      </li>
      <li>
        <router-link :to="{name:'BookView'}" style="color:rgb(159, 120, 96)">
          图书
        </router-link>
      </li>
      <li>
        <router-link :to="{name:'StatusView'}" style="color: rgb(228, 168, 19);">
          广播
        </router-link>
      </li>
       <li>
        <router-link :to="{name:'GroupView'}" style="color: rgb(42, 184, 204)">
          小组
        </router-link>
      </li>
    </ul>
